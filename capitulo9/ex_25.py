# Exercício 9.25: Altere as funções pede_nome e pede_telefone de forma a receberem um parâmetro opcional. 
...
def novo():
    ...
    alterada = True
    nome = pede_nome(erro = "Fulano")
    telefone = pede_telefone(erro = "67")
