# Exercício 10.10: Crie uma nova conta, agora tendo João e José como clientes e saldo igual a 500.
...
jose = Cliente("José Pereira", "555-4321")

conta = Conta([joao, jose], 1, 500)
